...
<body>
    ...
    <table id="customers">
        <tr>
            <td style="align-content: center"><h2>
                <?php $image_path = '/upload/school.png'; ?>
                <img src="{{ public_path() . $image_path }}" width="130" height="100">

            </h2></td>


            <td><h2>Shukridin School ERP</h2>
                <p>School Address</p>
    ...
    <hr style="border: dashed 2px; width: 95%; color: #000000; margin-bottom: 40px">
